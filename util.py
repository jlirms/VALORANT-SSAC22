...
class MatchesData():
    """Loads in all the matches, ids of collected data
    also splits to train, test and validation by matchIds"""

    def __init__(self, matches_fname, ids_fname, json_fname):
        """
        Alls fnames are strings pointing to the location of the file
        """
